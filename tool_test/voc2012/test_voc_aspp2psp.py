...
def main():
    ...
    if not args.has_prediction:
        ...
        target_model = PSPNet(layers=args.layers, classes=args.classes, zoom_factor=args.zoom_factor, pretrained=False)
        ...
        if os.path.isfile(args.model_path):
            ...
            target_checkpoint = torch.load('exp/voc2012/pspnet/1/model/train_epoch_50.pth')
