...
class Attack(object):
    ...
    def __init__(self, name, model, mean, std, normalization_applied=True):
        r"""
        ...
        self.normalization_used = {'mean':mean, 'std':std}
        self._normalization_applied = normalization_applied
